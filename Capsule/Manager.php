...
namespace Fabricate\Queue\Capsule;

use Fabricate\Chassis\Chassis;
use Fabricate\Queue\QueueManager;
use Fabricate\Queue\QueueServiceProvider;
use Fabricate\NutsAndBolts\Concerns\CapsuleManagerTrait;

/**
 * @mixin \Fabricate\Queue\QueueManager
 * @mixin \Fabricate\Contracts\Queue\Queue
 */
class Manager
{
     ...
     *
     * @var \Fabricate\Queue\QueueManager
     */
    protected $manager;
     ...
     *
     * @param  \Fabricate\Chassis\Chassis|null  $container
     */
     ...
     *
     * @return \Fabricate\Queue\QueueManager
     */
