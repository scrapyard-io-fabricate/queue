...
use Fabricate\Queue\RedisQueue;
...
class RedisJob extends Job implements JobContract
{
     ...
     *
     * @var \Fabricate\Queue\RedisQueue
     */
    protected $redis;
     ...
     * @param  \Fabricate\Queue\RedisQueue  $redis
     * @param  string  $job
     * @param  string  $reserved
     * @param  string  $connectionName
     * @param  string  $queue
     */
    public function __construct(Chassis $container, RedisQueue $redis, $job, $reserved, $connectionName, $queue)
    {
     ...
     *
     * @return \Fabricate\Queue\RedisQueue
     */
