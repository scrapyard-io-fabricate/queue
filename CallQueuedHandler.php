...
use Fabricate\Bus\BatchRepository;
...
use Fabricate\Queue\Events\JobDebounced;
...
class CallQueuedHandler
{
     ...
     *
     * @var \Fabricate\Contracts\Bus\Dispatcher
     */
    ...
    protected function ensureUniqueJobLockIsReleasedViaContext()
    {
        ...
        [$store, $key] = [
            $context->getHidden('fabricate_unique_job_cache_store'),
            $context->getHidden('fabricate_unique_job_key'),
        ];
