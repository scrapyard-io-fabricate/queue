...
use Fabricate\Contracts\Cache\Repository as CacheContract;
...
use Fabricate\Contracts\Queue\Interruptible;
use Fabricate\Database\DetectsLostConnections;
use Fabricate\Queue\Events\JobAttempted;
use Fabricate\Queue\Events\JobExceptionOccurred;
use Fabricate\Queue\Events\JobPopped;
use Fabricate\Queue\Events\JobPopping;
use Fabricate\Queue\Events\JobProcessed;
use Fabricate\Queue\Events\JobProcessing;
use Fabricate\Queue\Events\JobReleasedAfterException;
use Fabricate\Queue\Events\JobTimedOut;
use Fabricate\Queue\Events\Looping;
use Fabricate\Queue\Events\WorkerIdle;
use Fabricate\Queue\Events\WorkerInterrupted;
use Fabricate\Queue\Events\WorkerPausing;
use Fabricate\Queue\Events\WorkerResuming;
use Fabricate\Queue\Events\WorkerStarting;
use Fabricate\Queue\Events\WorkerStopping;
...
class Worker
{
     ...
     *
     * @var \Fabricate\Contracts\Queue\Factory
     */
    protected $manager;
     ...
     *
     * @var \Fabricate\Contracts\Events\Dispatcher
     */
    protected $events;
     ...
     *
     * @var \Fabricate\Contracts\Debug\ExceptionHandler
     */
     ...
     *
     * @var \Fabricate\Contracts\Queue\Job|null
     */
     ...
     *
     * @param  \Fabricate\Contracts\Queue\Factory  $manager
     * @param  \Fabricate\Contracts\Events\Dispatcher  $events
     * @param  \Fabricate\Contracts\Debug\ExceptionHandler  $exceptions
     ...
     * @param  string  $queue
     * @param  \Fabricate\Queue\WorkerOptions  $options
     * @return int
     */
     ...
     *
     * @param  \Fabricate\Contracts\Queue\Job|null  $job
     * @param  \Fabricate\Queue\WorkerOptions  $options
     * @return void
     */
     ...
     *
     * @param  \Fabricate\Contracts\Queue\Queue  $connection
     * @param  string  $queue
     * @return \Fabricate\Contracts\Queue\Job|null
     */
     ...
     * @param  string|null  $queue
     * @param  \Fabricate\Queue\WorkerOptions|null  $options
     * @return void
     */
     ...
     * @param  int  $status
     * @param  \Fabricate\Queue\WorkerOptions|null  $options
     * @param  \Fabricate\Queue\WorkerStopReason|null  $reason
     * @return never
     */
     ...
     *
     * @param  \Fabricate\Contracts\Queue\Job  $job
     * @return \Fabricate\Queue\MaxAttemptsExceededException
     */
     ...
     *
     * @param  \Fabricate\Contracts\Queue\Job  $job
     * @return \Fabricate\Queue\TimeoutExceededException
     */
     ...
     *
     * @return \Fabricate\Contracts\Queue\Factory
     */
