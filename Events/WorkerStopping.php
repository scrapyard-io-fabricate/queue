...
class WorkerStopping
{
     ...
     * @param  \Fabricate\Queue\WorkerOptions|null  $workerOptions  The worker options.
     * @param  \Fabricate\Queue\WorkerStopReason|null  $reason  The reason why the worker is stopping.
