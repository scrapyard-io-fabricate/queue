...
use Fabricate\Contracts\Queue\ClearableQueue;
use Fabricate\Contracts\Queue\Queue as QueueContract;
use Fabricate\Database\Connection;
use Fabricate\Queue\Jobs\DatabaseJob;
use Fabricate\Queue\Jobs\DatabaseJobRecord;
use Fabricate\Queue\Jobs\InspectedJob;
...
class DatabaseQueue extends Queue implements QueueContract, ClearableQueue
{
     ...
     *
     * @param  \Fabricate\Database\Connection  $database
     * @param  string  $table
     ...
     *
     * @param  string|null  $queue
     * @return \Fabricate\NutsAndBolts\Collection<int, \Fabricate\Queue\Jobs\InspectedJob>
     */
     ...
     *
     * @param  string|null  $queue
     * @return \Fabricate\Queue\Jobs\DatabaseJobRecord|null
     */
     ...
     *
     * @param  \Fabricate\Database\Query\Builder  $query
     * @return void
     */
     ...
     * @param  string  $queue
     * @param  \Fabricate\Queue\Jobs\DatabaseJobRecord  $job
     * @return \Fabricate\Queue\Jobs\DatabaseJob
     */
     ...
     *
     * @param  string  $queue
     * @param  \Fabricate\Queue\Jobs\DatabaseJob  $job
     * @param  int  $delay
     * @return void
     */
     ...
     *
     * @return \Fabricate\Database\Connection
     */
