...
use Fabricate\Bus\DebounceLock;
...
use Fabricate\Contracts\Queue\ShouldBeEncrypted;
use Fabricate\Contracts\Queue\ShouldBeUnique;
use Fabricate\Contracts\Queue\ShouldQueueAfterCommit;
use Fabricate\Queue\Attributes\Backoff;
use Fabricate\Queue\Attributes\DeleteWhenMissingModels;
use Fabricate\Queue\Attributes\FailOnTimeout;
use Fabricate\Queue\Attributes\MaxExceptions;
use Fabricate\Queue\Attributes\ReadsQueueAttributes;
use Fabricate\Queue\Attributes\Timeout;
use Fabricate\Queue\Attributes\Tries;
use Fabricate\Queue\Events\JobQueued;
use Fabricate\Queue\Events\JobQueueing;
...
abstract class Queue
{
     ...
     * @return string
     *
     * @throws \Fabricate\Queue\InvalidPayloadException
     */
    ...
    protected function createObjectPayload($job, $queue)
    {
        $payload = $this->withCreatePayloadHooks($queue, [
            ...
            'job' => 'Fabricate\Queue\CallQueuedHandler@call',
     ...
     *
     * @return \Fabricate\Chassis\Chassis
     */
